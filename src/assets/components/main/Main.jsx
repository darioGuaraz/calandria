...
const Main = () => {
  return (
    <section className="main">
      ...
      <div className="mainservices-general">
        <div className="mainservices">
          <div className="text-content">
            <h3>Desarrollo Web</h3>
            <p>
              Desarrollamos soluciones digitales a medida que combinan diseño
              centrado en el usuario con programación robusta y escalable.
              Creamos sitios web y aplicaciones utilizando código de tecnologías
              modernas como React y Vue, lo que garantiza un rendimiento óptimo
              y una base sólida para el crecimiento futuro, que pueda volar
              junto a tu negocio. No solo buscamos la funcionalidad, sino
              también una experiencia significativa que conecte con las personas
              que lo utilizan.
            </p>
          </div>
        ...
        <div className="mainservices">
          <div className="text-content">
            ...
            <p>
              ...
              personalizado y conocer nuestras opciones de pago flexibles
              pensadas para facilitar tu inversión en tecnología y comunicación.
            </p>
          </div>
          <div className="img-content">
            <video
